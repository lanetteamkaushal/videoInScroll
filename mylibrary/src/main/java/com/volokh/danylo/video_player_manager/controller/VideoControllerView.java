package com.volokh.danylo.video_player_manager.controller;
...
/**
 * Created by Bruce Too On 7/12/16. At 16:09
 */
public class VideoControllerView extends FrameLayout implements VideoGestureListener {
    ...
    /**
     * toggle {@link VideoControllerView} show or not this can be called when {@link
     * View#onTouchEvent(MotionEvent)} happened
     */
    ...
    /**
     * set gesture listen to control media player include screen brightness and volume of video and
     * seek video play
     */
...
//                    });
    ...
    /**
     * find all views inside {@link VideoControllerView} and init params
     */
    ...
    /**
     * set {@link #mSeekBar} progress and video play time {@link #mCurrentTime}
     *
    ...
    /**
     * hide controller view with animation With custom animation
     */
    public void hide() {
        if (mAnchorView == null) {
            return;
...
//                break;// do need bread,should let gestureDetector to handle event
    ...
    /**
     * Interface of Media Controller View Which can be callBack when {@link
     * android.media.MediaPlayer} or some other media players work
     */
    public interface MediaPlayerControlListener {
        ...
        /**
         * video is full screen in order to control image src...
         *
         * @return fullScreen
         */
